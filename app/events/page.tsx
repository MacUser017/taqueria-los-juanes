      ...
      <section className="mx-auto max-w-2xl px-4 pt-10">
        <article className="overflow-hidden rounded-xl border border-marigold/50 bg-black shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
          <div className="relative aspect-[2/3] w-full">
            <Image
              src="/media/photos/karaoke_los_juanes_september_26.webp"
              alt="Karaoke nighton Saturday, September 26 at 8 PM"
              fill
          ...
          <div className="p-5 text-center">
            ...
            <p className="mt-1 text-cocoa/75">Saturday, September 26 at 8:00-2am PM</p>
          </div>
        </article>
      </section>
